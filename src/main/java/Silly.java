...
public class Silly implements Comparable<Silly>{
     ...
     */
    /**
     * Create a new Silly object.
     * this constructor takes in two String as an argument.
     *
     * @param first a string for the first part of this Silly instance's name.
     * @param second a string for the second part of this Silly instance's name.
     */
